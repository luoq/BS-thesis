CC=icpc
CXXFLAGS=-ipo -prof-use -Dcolnnzs -Dnonnnz -w
#CC=g++
#CXXFLAGS=-march=i686 -mtune=native -O3 -pipe -Dcolnnzs
...
misc.o:misc.cpp misc.h
	$(CC) $(CXXFLAGS) -c $<
clean:
	rm *.o test_vec test_mat test_load Per research benchmark benchmark-one genRegular test_fmat RNW test_subsetGenerator 1>/dev/null 2>&1
